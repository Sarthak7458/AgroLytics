...
import { MapPin, Sprout, User, Edit, LogOut } from "lucide-react";
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-background py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto space-y-8">
                            ...
                            <div className="ml-40 pt-4 pb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500 dark:text-muted-foreground flex items-center mt-1">
                                        <MapPin className="w-4 h-4 mr-1 text-gray-400 dark:text-muted-foreground" /> {profile.location}
                                    </p>
                                </div>
                ...
                >
                    ...
                    <Card className="shadow-md bg-green-50 dark:bg-green-950/30 border-green-100 dark:border-green-800 h-full">
                        <CardHeader>
                            <CardTitle className="text-lg font-semibold flex items-center gap-2 text-green-800 dark:text-green-300">
                                <User className="w-5 h-5 text-green-600 dark:text-green-400" /> {t("profile.yourComparison")}
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
