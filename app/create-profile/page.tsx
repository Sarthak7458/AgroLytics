...
import { Sprout, MapPin, User, CheckCircle2 } from "lucide-react";
...
export default function CreateProfilePage() {
    ...
    const handleSelectChange = (value: string) => {
        setFormData((prev) => ({ ...prev, farmingType: value }));
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Simulate a brief delay specifically for UX to show the user something is happening
        setTimeout(() => {
                ...
                <Card className="border-none shadow-xl bg-white/90 dark:bg-card/90 backdrop-blur-sm">
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="location" className="text-gray-700 dark:text-foreground flex items-center gap-2">
                                    <MapPin className="w-4 h-4 text-green-600 dark:text-green-400" /> {t("createProfile.location")}
                                </Label>
                                <Input
                                    id="location"
                                    name="location"
